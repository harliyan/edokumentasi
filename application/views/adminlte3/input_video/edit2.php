   ...
   <?php foreach($tb_telecenter as $data){ ?>
    ...
    <div class="card-body">
      <div class="tab-content">
        <form class="form-horizontal" action="<?php echo site_url(). '/superadmin/input_video/update'; ?>" role="form" method="post"> 
          <div class="row">
           ...
           <br>
             ...
             <a class="btn btn-danger" href="<?php echo base_url() ?>superadmin/input_video">Batal</a>
          </div>
        </form>
      <?php } ?>
    </section>
