   ...
   <?php foreach($tb_telecenter as $data){ ?>
    ...
    <div class="card-body">
      <div class="tab-content">
        <form class="form-horizontal" action="<?php echo site_url(). '/superadmin/input_file/update'; ?>" role="form" method="post"> 
          <div class="row">
           ...
           <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <a class="btn btn-danger" href="<?php echo base_url() ?>superadmin/input_file">Batal</a>
          </div>
        </form>
      <?php } ?>
    </section>
