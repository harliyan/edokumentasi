         ...
         <table id="example2" class="table table-bordered table-striped" style="width:auto">
           <thead class="thead-dark">
            <tr class="text-black">
              ...
              <th style="text-align: center;">Ekstensi File</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;">
                <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>superadmin/input_file/edit/<?php echo $data->id ?>">Edit</a>
                <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>superadmin/input_file/hapus/<?php echo $data->id ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
              </td>
            <?php endforeach ?>
          </tbody>  
        </table>
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tambah-data" class="modal fade">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form class="form-horizontal" action="<?php echo base_url('superadmin/input_file/tambah_aksi')?>" method="post" enctype="multipart/form-data" role="form">
            <div class="modal-body">
              ...
              <div>
               ...
               <label for="exampleFormControlInput1">Untuk File ekstensi .cdr dibuat .zip terlebih dahulu</label>
             </div>
             <br>
             <div class="form-group">
          ...
          <div class="form-group">
           <div class="form-group">
            <label for="exampleFormControlSelect1">Ekstensi File</label>
