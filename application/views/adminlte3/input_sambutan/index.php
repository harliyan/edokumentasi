...
<div class="page-header row no-gutters py-4">
  <div class="col-12 col-sm-12 text-center text-sm-left mb-0">
    <h1 class="page-title">INPUT FILE</h1>
  </div>
</div>
<!-- End Page Header -->
...
<div class="row">
  <div class="col-lg-6">
    <div class="card mb-4">
      <div class="card-body">
        <p class="card-text">Masukan File</p>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;">
                ...
                <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/input_sambutan/hapus/<?php echo $data->id ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
              </td>
  ...
  <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tambah-data" class="modal fade">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('admin/input_sambutan/tambah_aksi')?>" method="post" enctype="multipart/form-data" role="form">
