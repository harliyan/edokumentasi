...
<div class="row">
	<div class="col 6">
		<h2 class="text-center" style="text-align: center;">Laporan Record Download File Foto</h2>
	</div>
</div>
...
<p style="font-size:11px;">Tanggal Cetak : <?php echo date("D-d/m/Y") ?></p>
     ...
     <table border="1"  align="center" cellpadding="2" cellspacing="2" >
        ...
        <th  style="text-align: center; font-size:11px;">Google Photo Link</th>
       ...
       <tbody>
        <?php 
        $no=1;
        $data = $this->db->get('tb_record_foto')->result();
    ...
    <tr>
      ...
      <td style="text-align: center; font-size:11px;"><?php echo $data -> google_photo_link; ?></td>
