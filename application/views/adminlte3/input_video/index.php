          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;">
                <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/input_video/edit/<?php echo $data->id ?>">Edit</a>
                <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/input_video/hapus/<?php echo $data->id ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
              </td>
            <?php endforeach ?>
          </tbody>
        </table>
      ...
      <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tambah-data" class="modal fade">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('admin/input_video/tambah_aksi')?>" method="post" enctype="multipart/form-data" role="form">
