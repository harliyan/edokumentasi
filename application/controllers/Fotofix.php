...
class Foto extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $config['base_url']     = site_url('foto/index');                       //arah site dan function nya
    $config['total_rows']   = $this->db->count_all('tb_doc_foto');          //total row
    $config['per_page']     = 3;                                            //show data per halaman
