...
<div class="page-header row no-gutters py-4">
  <div class="col-12 col-sm-12 text-center text-sm-left mb-0">
    ...
    <h1 class="page-title">REPORT RECORD DOWNLOAD FILE SAMBUTAN</h1>
  </div>
</div>
<!-- End Page Header -->
  ...
  <div class="col">
    <div class="card mb-4">
      <div class="card-body">
        ...
        <a href="<?php echo base_url('admin/mpdf_all'); ?>"  target="_blank" class="form-control btn btn-danger"><i class="glyphicon glyphicon glyphicon-floppy-save"></i> Cetak PDF</a>
      </div> 
       <!-- TABLE -->
         ...
         <table id="example2" class="table table-bordered table-striped" style="width:auto">
          <thead class="thead-dark">
            <tr class="text-black">
              ...
              <th style="text-align: center;">Path File</th>
          ...
          <tbody>
            <?php 
            $no=1;
            foreach ($tb_record_sambutan as $data)
              : ?>
            <tr>
