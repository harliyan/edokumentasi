...
?>
   ...
   <head>
        <meta charset="utf-8" />
        <title>SIAP KAWAL</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta content="SIAP KAWAL - Sistem Aplikasi Dokumentasi Kegiatan Wali Kota Pekalongan" name="Sistem Aplikasi Dokumentasi Kegiatan Wali Kota Pekalongan" />
        <meta content="siapkawal.pekalongankota.go.id" name="Harliyan Tri Mardian" />
